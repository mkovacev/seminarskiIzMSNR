...
\chapter{Recenzent \odgovor{\\Krupne primedbe i sugestije:
		\\-
		\\-
		\\-Dodato je objašnjenje o pojmu „Nigerijska prevara”.
		\\- 
		\\Sitne primedbe:
		\\-Imali smo problem sa virtuelnom mašinom prilikom pisanja seminarskog rada, paket je sada uspešno dodat.
		\\-
		\\-
		\\-
		\\-
		...
		\\-
		\\-
		\\-- Ispravljena je greška, sada piše \textit{Internet}.\newline
		- Rečenica je preformulisana, sada glasi „\textit{Javno je dostupna i svako joj može pristupiti, moguće je da više autora napiše jedan članak.}”\newline
		- Ispravljene su slovne greške: -umesto \textit{odlucni}, sada piše \textit{odlučni}.\newline
		- umesto \textit{period}, sada piše \textit{periodu}.\newline
		- umesto \textit{reć}, sada piše \textit{reč}. Referenca je postavljena pre tačke i ispravljeni su navodnici.\newline
		- Dodat je razmak nakon zareza.\newline
		- Rečenica je preformulisana, sada glasi \\„\textit{Korsgaard i Jensen su 2009. godine predložili određene promene na softveru za Vikipediju, kako bi ocene koje su prethodno bile na člancima bile ubačene i u poslednje verzije.}”\newline
		-U rečenici je izbačena reč \textit{dosta} i ispravljene su navedene greške, sada glasi „\textit{Ljudi se oslanjaju na komunikaciju putem Interneta, Internet bankarstvo i Internet trgovinu.}”\newline
		- Rečenica je preformulisana i ispravljene su slovne greške „\textit{Pecanje (eng. phishing) predstavlja dobro poznatu vrstu napada socijalnog inženjeringa.}”
